...
public class GeneralBasicsJS : MonoBehaviour
{
	...
	{
		LeanTween.delayedCall(gameObject, 14f, _0024advancedExamples_0024closure_002410).setOnCompleteOnStart(isOn: true).setRepeat(-1);
	}
	...
	internal void _0024advancedExamples_0024closure_002410()
	{
		for (int i = 0; i < 10; i++)
		{
...
#if ENABLE_NOT_DECODE
                .setOnComplete(_0024adaptor_0024__GeneralBasicJS_0024callable1_002461_33___0024Action_00240.Adapt(_0024_0024advancedExamples_0024closure_002410_0024closure_002411))
...
#if ENABLE_NOT_DECODE
				.setOnComplete(_0024adaptor_0024__GeneralBasicJS_0024callable2_002471_33___0024Action_00241.Adapt(_0024_0024advancedExamples_0024closure_002410_0024closure_002412))
				.setOnCompleteParam(gameObject)
#endif
                ;
		}
	...
	internal LTDescr _0024_0024advancedExamples_0024closure_002410_0024closure_002411(GameObject rot)
	{
		return LeanTween.rotateAround(rot, Vector3.forward, -1080f, 12f);
	}

	internal void _0024_0024advancedExamples_0024closure_002410_0024closure_002412(GameObject rot)
	{
