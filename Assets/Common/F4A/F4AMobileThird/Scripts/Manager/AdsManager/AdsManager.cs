...
#pragma warning disable 414
        ...
        public static event Action<EBannerAdNetwork> OnBannerAdShow = delegate { };
...
#region Unity Method
        ...
        private void Start()
        {
            ...
            OnBannerAdShow += AdsManager_OnBannerShow;
...
#if UNITY_EDITOR
                            DMCHelper.SaveFile(data, NameFileAdsInfo);
#endif
                        }
...
#region Interstitial Ads
...
#if DEFINE_IRONSOURCE
                if (adsType == EInterstitialAdNetwork.IronSource)
                {
        ...
        public bool ShowInterstitialAds(int adsInterval = -1, Action onCompleted = null, Action onSkiped = null, Action onFailed = null)
        {
